...
namespace SemWeb.Remote
{
    ...
    public class SparqlHttpSource : QueryableSource, SparqlSource
    {
        ...
        {
            string qstr = "query=" + UnityEngine.WWW.EscapeURL(query);
            //string qstr = "query=" + System.Net.WebUtility.UrlEncode(query);
            //string qstr = "query=" + System.Web.HttpUtility.UrlEncode(query);
            System.Net.ICredentials StreetCred = new System.Net.NetworkCredential("user1", "guest");
